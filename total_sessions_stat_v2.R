...
stat <- function(cname){
  ...
  bi_data <- read.csv(paste("C:/Users/Lily/Documents/GA/R/report/2017/bi-weekly/0417-0428/total_dat/", cname, ".csv", sep=""), header=T)
...
C$lan <- lan_list
as.data.frame(C)
write.csv(C, 'C:/Users/Lily/Documents/GA/R/report/2017/bi-weekly/0417-0428/stat_lan_v2.csv')
